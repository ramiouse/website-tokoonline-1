          ...
          <div class="col-lg-4">
            ...
            <form method="POST" class="mt-3" action="{{ route('register') }}">
              ...
              <div class="form-group">
                ...
                <!-- pake custom-radio semua type radio sama di browser -->
...
<script>
  ...
  var register = new Vue({
      ...
      checkForEmailAvailability: function(){
        ...
        .then((response) => {
          if(response.data == 'Available') {
            self.$toasted.show(
              "Email anda tersedia, Silahkan lanjur langkah selanjutnya!",
              {
                position: "top-center",
                className: "rounded",
                duration: 1000
            ...
            self.$toasted.error(
              "Maaf, tampkanya email sudah terdaftar pada sistem kami.",
              {
                position: "top-center",
                className: "rounded",
                duration: 1000
    ...
    data() {
      return {
        name: "Rizkfi afinnudin mahzi",
        email: "riskiadfinnudinmzid@gmail.com",
        is_store_open: true,
        store_name: "",
